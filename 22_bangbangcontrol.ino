...
#define _INTERVAL_DIST    155 // distance sensor interval (unit: ms)
#define _INTERVAL_SERVO   300 // servo interval (unit: ms)
...
#define _SERVO_ANGLE_DIFF  215  // Replace with |D - E| degree
...
float volt_to_distance(int a_value)
{
  ...
  return 863 + (-3.17)*(a_value) + (2.95)*(10^(-3))*(a_value)*(a_value);
}
